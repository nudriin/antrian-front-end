...
export default function LocketKeuangan() {
    const total = useTotalQueue("keuangan")
    const initialNext = useNextQueue("keuangan")
    const initialCurrent = useCurrentQueue("keuangan")
    const initialRemain = useRemainQueue("keuangan")
    const initialQueues = useAllQueueInLocket("keuangan")
    const initalLocket = useLocketByName("keuangan")
                                            ...
                                            <td className="flex items-center justify-center p-2">
                                                <button
                                                    onClick={(
                                                        ...
                                                        const text = `Nomor antrian, G,${String(
                                                            value.queue_number
                                                        ).padStart(
                                                            2,
                                                            "0"
