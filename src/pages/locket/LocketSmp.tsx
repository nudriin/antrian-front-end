...
export default function LocketSmp() {
    const total = useTotalQueue("smp")
    const initialNext = useNextQueue("smp")
    const initialCurrent = useCurrentQueue("smp")
    const initialRemain = useRemainQueue("smp")
    const initialQueues = useAllQueueInLocket("smp")
    const initalLocket = useLocketByName("smp")
                                            ...
                                            <td className="flex items-center justify-center p-2">
                                                <button
                                                    onClick={(
                                                        ...
                                                        const text = `Nomor antrian, D,${String(
                                                            value.queue_number
                                                        ).padStart(
                                                            2,
                                                            "0"
